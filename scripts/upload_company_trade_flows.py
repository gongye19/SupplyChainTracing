...
# 0 means keep every aggregated counterparty row for whitelist companies.
TOP_COUNTERPARTIES_PER_COMPANY_ROLE = int(os.getenv("COMPANY_IMPORT_TOP_COUNTERPARTIES", "0"))
